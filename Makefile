...
CFLAGS += -Wno-unused-but-set-variable  # Need this on new gcc that doesn't like unused variables
...
ULIB = ulib.o usys.o printf.o umalloc.o mypthread.o
...
EXTRA=\
	...
	printf.c umalloc.c mypthread.c\
